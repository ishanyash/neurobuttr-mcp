...
export function registerMapTools(server) {
    server.tool("nb_map", `Generate a visual relationship map of the conversation. By default writes a Mermaid diagram to .neurobuttr/map.mmd that can be previewed in VS Code with the Mermaid Preview extension. Also returns an ASCII summary in the response.`, {
        format: z
            .enum(["mermaid", "ascii", "json"])
            .optional()
            .default("mermaid")
            .describe("Output format: 'mermaid' (writes .mmd file for VS Code preview, default), 'ascii' (text tree), or 'json' (structured data)"),
        cwd: z
            .string()
            .optional()
...
//# sourceMappingURL=map-tools.js.map