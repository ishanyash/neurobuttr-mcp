import { z } from "zod";
import { timelineProjectHash, loadTimelineIndex, loadTimelineSession, saveTimelineSession, } from "../storage.js";
export function registerTimelineAnnotateTools(server) {
    server.tool("nb_timeline_annotate", `Add tags or notes to a captured timeline session. Tags are appended to existing tags. Notes replace the existing note.`, {
        session_id: z
            .string()
...
//# sourceMappingURL=annotate-tools.js.map